  ...
  class Taiwan
    ...
    CITY_ZONE_ZIP_CODES = {
      ...
      "高雄市" => {
        ...
        "左營區" => "813", "仁武區" => "814", "大社區" => "815", "東沙群島" => "817", "南沙群島" => "819",
        "岡山區" => "820", "路竹區" => "821", "阿蓮區" => "822", "田寮區" => "823", "燕巢區" => "824",
        "橋頭區" => "825", "梓官區" => "826", "彌陀區" => "827", "永安區" => "828", "湖內區" => "829",
        "鳳山區" => "830", "大寮區" => "831", "林園區" => "832", "鳥松區" => "833", "大樹區" => "840",
        "旗山區" => "842", "美濃區" => "843", "六龜區" => "844", "內門區" => "845", "杉林區" => "846",
    ...
    def self.code_regex
      /(.{0,2}市|.{0,2}縣)(新市區|左鎮區|平鎮區|釣魚台列嶼|東沙群島|南沙群島|那瑪夏區|阿里山|.{0,2}區|.{0,3}鄉|.{0,2}鎮|.{0,2}市)/
    end
